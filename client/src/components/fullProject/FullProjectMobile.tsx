  ...
  return (
    <animated.div className="noScrollBar"
      ...
      <animated.div style={{ ...titleStyle, textAlign: "center" }}>
        {currentProject.mainImage != null ? <img src={currentProject.mainImage.asset.url} style={{ backgroundColor: "transparent" }} /> :
      ...
      {currentProject.deployUrl ?
        <div style={{ textAlign: "center", marginTop: "100px" }}>
          <a onClick={e => e.stopPropagation()} target="_blank" href={currentProject.deployUrl}><h3>Visit live site</h3></a>
        </div> : null}
      <div style={{ textAlign: "center", marginTop: "100px" }}>
