  ...
  return (
    <animated.div className="noScrollBar"
      ...
      {currentProject.tech != null &&
        <div>
          <animated.div style={{ ...techStyle, marginTop:"50px" }}>
      ...
      {currentProject.githubRepositoryLink ?
            <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", marginTop:"80px" }}>
              <a onClick={(e)=>{e.stopPropagation()}} className="buttidybuttbutt" href={currentProject.githubRepositoryLink} target="_blank" >
                Go to github repo
              </a>
            </div>
            : null}
          {currentProject.deployUrl ?
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <a onClick={(e)=>{e.stopPropagation()}} className="buttidybuttbutt" target="_blank" href={currentProject.deployUrl}>
                Go to live build </a>
            </div> : null}
