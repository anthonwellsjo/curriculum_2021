  ...
  return (
    <>
      <div onClick={onClickEventHandler} style={{ width: "100%", height: "100%", position: "absolute", display: "flex", justifyContent: "center", alignItems: "center", userSelect: "none", }}>
        <div onClick={(e) => { if (page.audio) { playClick(); } e.stopPropagation(); }} style={{ display: "flex", flexDirection: width <= 450 ? "column" : "row", alignItems: "center", height: width <= 450 ? "40%" : "auto", width: width > 401 ? "40%" : "auto", minWidth: "250px", justifyContent: "space-between", marginTop: "-200px" }}>
